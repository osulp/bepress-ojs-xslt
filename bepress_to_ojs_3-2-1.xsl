...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- 
        ...
        Bepress Digital Commons to Open Journal Systems (OJS) version 3.1.4. It has been modified
        to work with OJS version 3.2.1 schemas.
                    ...
                    <articles>
                        ...
                        <xsl:for-each
                            ...
                            <xsl:element name="article">
                                ...
                                <submission_file id="{$submission_id}" stage="proof">
                                ...
                                <publication>
                                    ...
                                    <xsl:if
                                        test="distribution_license[contains(text(), 'http')][not(contains(text(), ' '))]">
                                        <licenseUrl>
                                    ...
                                    <xsl:choose>
                                        ...
                                        <xsl:otherwise>
                                            ...
                                            <authors>
                                                <author user_group_ref="Author" seq="0" id="0">
                                                  <givenname>
                                                  <xsl:value-of
                                                  select="$local_data/default_author/givenname"/>
                                                  </givenname>
                                                  <familyname>
                                                  <xsl:value-of
                                                  select="$local_data/default_author/familyname"/>
                                                  </familyname>
                                                  <affiliation>
                                                  <xsl:value-of
                                                  select="$local_data/default_author/affiliation"/>
                                                  </affiliation>
                                                  <email>
                                                  <xsl:value-of
                                                  select="$local_data/default_author/email"/>
                                                  </email>
                                                </author>
                                            </authors>
                                        </xsl:otherwise>
    ...
    <xsl:template name="author">
        ...
        <xsl:element name="author" xmlns="http://pkp.sfu.ca">
            ...
            <xsl:attribute name="seq">0</xsl:attribute>
